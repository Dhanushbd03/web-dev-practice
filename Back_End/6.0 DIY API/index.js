...
app.get("/jokes/:id",(req,res)=>{
  ...
  const foundJoke = jokes.find((a)=> a.id === id);
  res.json(foundJoke);
...
app.put("/jokes/:id",(req,res)=>{
  ...
  const searchbox = jokes.findIndex((i) => i.id === id );
  jokes[searchbox] = replaceJoke ; 
...
app.patch("/jokes/:id",(req,res)=>{
  const id = parseInt(req.params.id);
  const existingJoke = jokes.find((i) => i.id === id );
  const replaceJoke = {
    id  :id ,
...
app.delete("/jokes/:id",(req,res)=>{
  ...
  const deletejoke = jokes.findIndex((i) => i.id === id );
  console.log(deletejoke);
if(deletejoke  > -1) {
  const deletedJoke = jokes.splice(deletejoke,1)
